...
/* 工程量转换系数 (放大 1e4 倍做整数运算; 顺序 = 通道号 AI0-3) */
static const uint32_t ai_coeff[AI_NUM] = {7414, 7414, 3704, 3704};

/* 12-bit raw -> 工程量 (0.01mA / 0.01V); 两步整除:
 * voltage 先整除截断, 系数乘积 64 位再整除 */
...
#include "history.h"
#include "io_hooks.h" /* io_now_epoch */
#include "log.h"
...
/* 通道表: IN10-13 = PC0-PC3 = AI0-3 (顺序即通道号) */
